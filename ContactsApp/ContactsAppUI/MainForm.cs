...
namespace ContactsAppUI
{
    public partial class MainForm : Form
    {
        ...
        private void ContactsListbox_MouseClick(object sender, MouseEventArgs e) //событие при клике на элемента списка формы
        {
        ...
        private void AddTooltripenutem_Click(object sender, EventArgs e) //событие при клике "add"
        {
        ...
        private void EditTolstripmenuitem_Click(object sender, EventArgs e) //событие при клике "edit"
        {
        ...
        private void RemoveToolstripmenuitem_Click(object sender, EventArgs e) //событие при клике "remove"
        {
            ...
            {
                DialogResult result = MessageBox.Show("Remove selected item?", "Remove", MessageBoxButtons.OKCancel); //вывод подтвержающего окна об удалении
        ...
        private void ExitToolstripmenuitem_Click(object sender, EventArgs e) //событие при нажатии кнопки закрытия формы
        {
            Close();
        }

        private void MainForm_FormClosing(object sender, FormClosingEventArgs e) //окно подтверждения выхода из программы
        {
        ...
        private void AboutToolstripmenuIiem_Click(object sender, EventArgs e) //событие при нажатии на кнопку "about"
        {
            AboutForm.AboutFormList.ShowForm(); //вывод формы about
        }

        private void FindTextbox_TextChanged(object sender, EventArgs e) //событие при введении текста в поле ввода искомого контакта
        {
